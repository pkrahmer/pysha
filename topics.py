...
topics = \
    topics_heatpump + topics_advanced + topics_heating + topics_cooling + topics_dhw + \
    topics_zone_1 + topics_zone_2 + topics_pool + topics_solar + topics_buffer + topics_compressor + \
    topics_pump + topics_heating_rod + topics_fans
